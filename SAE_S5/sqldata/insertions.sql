...
('S001', 'Soirée Comédie', 'Comédie', '2024-11-05 20:00:00', 'L1', 1000, 20.0, 15.0),
('S002', 'Soirée Jazz', 'Jazz', '2024-11-12 21:00:00', 'L2', 500, 25.0, 18.0),
('S003', 'Concert Rock', 'Rock', '2024-12-01 19:30:00', 'L3', 3000, 30.0, 22.0);
...
('B1', (SELECT ID FROM USERS WHERE email = 'user1@example.com'), 'S001', 'Normal', 20),
('B2', (SELECT ID FROM USERS WHERE email = 'user2@example.com'), 'S002', 'Réduit', 18),
('B3', (SELECT ID FROM USERS WHERE email = 'user3@example.com'), 'S003', 'Normal', 30);
